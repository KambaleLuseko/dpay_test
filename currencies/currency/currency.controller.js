...
let CurrencyController = class CurrencyController {
    ...
    async findAll(params) {
        return this.currencyService.findAll(params.value);
    }
    async findAllRates(params) {
        return this.currencyService.findAllRates(params.value);
    }
    async create(data) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], CurrencyController.prototype, "findAllRates", null);
__decorate([
    (0, common_1.Post)(),
