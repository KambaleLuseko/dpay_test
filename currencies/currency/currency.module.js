...
const currency_provider_1 = require("./currency.provider");
const currency_service_1 = require("./currency.service");
let CurrencyModule = class CurrencyModule {
};
CurrencyModule = __decorate([
    (0, common_1.Module)({
        imports: [rate_module_1.RateModule],
        controllers: [currency_controller_1.CurrencyController],
        providers: [currency_service_1.CurrencyService, ...currency_provider_1.currencyProvider]
    })
], CurrencyModule);
